...
public class JarvisValidateCodeAutoConfiguration {
    ...
    ValidateCodeGenerator imageValidateCodeGenerator(JarvisSecurityProperties securityProperties) {
    ...
    ValidateCodeGenerator mobileValidateCodeGenerator(JarvisSecurityProperties securityProperties) {
        final ValidateCodeProperties validateCodeProperties = securityProperties.getValidateCode();
    ...
    ValidateCodeSecurityConfig validateCodeSecurityConfigurer(
            ...
            ValidateCodeProcessorHolder validateCodeProcessorHolder, JarvisSecurityProperties securityProperties) {
    ...
    @Bean
    ValidateCodeConfigService validateCodeConfigService(JarvisSecurityProperties securityProperties) {
